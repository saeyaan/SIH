...
const StudentChat = () => {
  ...
  return (
    <div style={{ padding: 'var(--spacing-md)', maxWidth: '800px', margin: '0 auto', animation: 'fadeIn 0.4s ease' }}>
      <h2 style={{ fontSize: '1.75rem', fontWeight: 800, color: 'var(--color-primary-dark)', marginBottom: 'var(--spacing-md)' }}>Chat with Teacher</h2>
      
      <Card style={{ display: 'flex', flexDirection: 'column', height: '600px', padding: '0' }}>
        <div style={{ flex: 1, overflowY: 'auto', padding: 'var(--spacing-lg)', display: 'flex', flexDirection: 'column', gap: 'var(--spacing-md)', background: 'var(--color-bg-main)', borderTopLeftRadius: 'var(--radius-lg)', borderTopRightRadius: 'var(--radius-lg)' }}>
          {messages.length === 0 ? (
